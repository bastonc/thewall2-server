        ...
        if ($request->hasFile('Image')) {
            ...
            for ($i = 1; $i <= request()->edit_sps_count; $i++) {
                ...
                if (request()->$spsscore != NULL) {
                    ...
                    $resultInfo[] = request()->$spscall . "немае значення балів";
                }
            }
...
//dd($spsArray);
                        ...
                        if ($request->$call != NULL) {
                            if ($request->$score != NULL) {
                                ...
                                if ($chek == NULL) {
                                    ...
                                    $resultInfo[] = $request->$call . " вже включено до цієї программи";
                                }
                            } else {
                                $resultInfo[] = $request->$call . " немає кількості балів";
                            }
                        }
                    }
                }
    ...
    public function closeProgramm($token)
    {
        $tokenprogram = $token;
    ...
    public function openProgramm($tokenprogram)
    {
