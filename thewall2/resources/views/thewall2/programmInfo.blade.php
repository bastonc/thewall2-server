                        ...
                        <div class="row" >
                            <div class="col-md-4 center-block text-center " style="align-content: center">
                                ...
                                <table border="1" style=" border-color: #fff; color:#101010; width:100%">
                                    <tr><td colspan="3" style="background-color:#a4aaae;">Потрібно набрати балів: {{$programm->scoreFinal}}</td>
                                    ...
                                    @foreach($spsMember as $sps)
                                        <tr style="background-color:#e8eeee"><td align="left" >&nbsp;{{$sps->call}}&nbsp;</td><td>{{$sps->mode}}</td><td align="right">&nbsp;{{$sps->score}}&nbsp;</td></tr>
